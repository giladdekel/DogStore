...
export const PRODUCT_CATEGORY_LIST_REQUEST_3 =
  "PRODUCT_CATEGORY_LIST_REQUEST_3";
export const PRODUCT_CATEGORY_LIST_SUCCESS_3 =
  "PRODUCT_CATEGORY_LIST_SUCCESS_3";
export const PRODUCT_CATEGORY_LIST_FAIL_3 = "PRODUCT_CATEGORY_LIST_FAIL_3";

export const PRODUCT_TOPSELLERS_LIST_REQUEST = "USER_TOPSELLERS_LIST_REQUEST";
export const PRODUCT_TOPSELLERS_LIST_SUCCESS = "USER_TOPSELLERS_LIST_SUCCESS";
export const PRODUCT_TOPSELLERS_LIST_FAIL = "USER_TOPSELLERS_LIST_FAIL";
