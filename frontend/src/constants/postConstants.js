...
export const POST_CATEGORY_LIST_FAIL = "POST_CATEGORY_LIST_FAIL";

export const POST_CATEGORY_LIST_REQUEST_3 = "POST_CATEGORY_LIST_REQUEST_3";
export const POST_CATEGORY_LIST_SUCCESS_3 = "POST_CATEGORY_LIST_SUCCESS_3";
export const POST_CATEGORY_LIST_FAIL_3 = "POST_CATEGORY_LIST_FAIL_3";

export const POST_TOPSELLERS_LIST_REQUEST = "POST_TOPSELLERS_LIST_REQUEST";
export const POST_TOPSELLERS_LIST_SUCCESS = "POST_TOPSELLERS_LIST_SUCCESS";
export const POST_TOPSELLERS_LIST_FAIL = "POST_TOPSELLERS_LIST_FAIL";
